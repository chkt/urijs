...
/**
 * Returns a instance created from <code>string</code>
 * @param {String}       string      The query <em>component</em> string
 * @param {Char}        [keyLimit]   The key delimiter
 * @param {Char}        [valueLimit] The value delimiter
 * @param {Char}        [listLimit]  The value list seperator
 * @param {URIKeyValue} [target]     The target instance
 ...
 * @throws {TypeError} if <code>keyLimit</code> is not a <code>Char</code> or <code>undefined</code>
 */
URIKeyValue.QueryString = function(string, keyLimit, valueLimit, listLimit, target) {
	if (keyLimit === undefined) keyLimit = URIKeyValue.DELIMITER_DEFAULT_KEY;
	else if (typeof keyLimit !== 'string' || keyLimit.length !== 1) throw new TypeError();
	
	return URIKeyValue.String(string.replace(/\?/g, keyLimit), keyLimit, valueLimit, listLimit, target);
};
