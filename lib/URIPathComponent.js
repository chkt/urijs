 ...
 * @memberOf URIPathComponent#
 * @type String[]
 * @throws {TypeError} if the set argument is not a nonempty <code>Array</code> of <code>String</code>s
 */
 ...
 * @memberOf URIPathComponent#
 * @type Boolean
 * @throws {TypeError} if the set argument is not a <code>Boolean</code>
 */
 ...
 * @memberOf URIPathComponent#
 * @type String
 * @throws {TypeError} if the set argument is not a valid path <em>segment</em> <code>String</code>
 */
