...
Object.defineProperty(URI.prototype, 'string', {
	...
	set : function(string) {
		...
		if (name !== null) {
			this.user.chars = user !== null ? user[1] : "";
			this.name.chars = name[1],
			this.port.chars = port !== null ? port[1] : "";
		}
		
		this.scheme.chars   = scheme !== null ? scheme[1] : "";		
		this.path.chars     = path   !== null ? path[1]   : "";
		this.query.chars    = query  !== null ? query[1]  : "";
		this.fragment.chars = frag   !== null ? frag[1]   : "";
	},
	configurable : true,
	enumerable : true
});
 ...
 * @type String
 */
Object.defineProperty(URI, 'VERSION', {value : "0.1.0"});
...
URI.copy = function(uri) {
	...
	for (var s in uri) {
		if (!(uri[s] instanceof URIComponent)) continue;
