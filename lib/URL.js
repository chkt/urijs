 ...
 * @memberOf URINameComponent#
 * @type String[]
 * @throws {TypeError} <code>{@link URIComponent.ERROR_ARGUMENT}</code> if the set argument is not a nonempty <code>Array</code> of nonempty <code>Strings</code>
 */
...
/**
 * Returns a string representation of the <em>segment</em>
 ...
 */
URINameComponent.toString = function(flags) {
...
URINameComponent.ComponentString = function(string, flags, target) {
	if (!string || typeof string != 'string' || flags !== undefined && (typeof flags != 'number' || flags << 0 != flags)) throw new TypeError(URIComponent.ERROR_ARGUMENT); 
