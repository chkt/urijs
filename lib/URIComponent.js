 ...
 * @return {URIComponent}
 * @throws {TypeError} if <code>type</code> is not a valid <em>type</em>
 */
 ...
 * @memberOf URIComponent#
 * @type String
 * @throws {URIError}  if getting a invalid <em>component</em>
 * @throws {TypeError} if not setting a <code>String</code>
 * @throws {URIError}  if setting a invalid <em>component</em>
 */
